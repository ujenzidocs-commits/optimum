export interface ServiceItem { id:string; title:string; desc:string; icon:string; features:string[] }
...
export const defaultData: SiteData = {
  ...
  services: [
    {id:'1',title:'Tally Prime Installation & Setup',desc:'Complete installation, configuration, and data migration for Tally Prime Silver & Gold editions. Get up and running in 24 hours.',icon:'Download',features:['License activation','Data migration','Multi-user setup','Initial training']},
    {id:'2',title:'Inventory Management',desc:'Real-time stock tracking, batch management, reorder alerts, and multi-location inventory control powered by Tally Prime.',icon:'Package',features:['Real-time tracking','Batch & expiry management','Reorder alerts','Multi-location support']},
    {id:'3',title:'Payroll Systems',desc:'Automated payroll processing fully configured for Kenyan statutory requirements — PAYE, NHIF, NSSF, Housing Levy.',icon:'Wallet',features:['Auto salary processing','PAYE/NHIF/NSSF','Payslip generation','Leave management']},
    {id:'4',title:'Manufacturing Solutions',desc:'Streamline production with Bill of Materials, production orders, work-in-progress tracking, and cost analysis.',icon:'Factory',features:['BOM management','Production orders','Cost tracking','Quality control']},
    {id:'5',title:'KRA Compliance',desc:'Stay 100% compliant with KRA. Automated VAT, income tax, PAYE calculations, and e-filing integration.',icon:'FileCheck',features:['VAT management','e-Filing integration','Tax reports','Audit trail']},
    {id:'6',title:'TDL Customization',desc:'Custom Tally Definition Language development to tailor Tally Prime to your exact business workflows.',icon:'Code',features:['Custom reports','Workflow automation','Integration APIs','Module extensions']},
    {id:'7',title:'Remote & On-site Support',desc:'24/7 remote assistance plus scheduled on-site visits. Average response time under 1 hour.',icon:'Headphones',features:['24/7 remote support','On-site visits','Software updates','Troubleshooting']},
    {id:'8',title:'ERP & Business Consulting',desc:'Strategic consulting to optimize your business processes, select the right ERP modules, and plan digital transformation.',icon:'BarChart3',features:['Process mapping','ERP selection','Digital strategy','Change management']},
  ],
  products: [
    {id:'1',name:'TallyPrime',edition:'Silver',price:'KES 54,000',period:'one-time',features:['Single user license','Full accounting and invoicing','Inventory and stock reports','Payroll configuration','KRA VAT and eTIMS ready','Free updates for 1 year','Email and remote support'],cta:'Get Silver'},
    {id:'2',name:'TallyPrime',edition:'Gold',price:'KES 162,000',period:'one-time',popular:true,features:['Unlimited multi-user access','All Silver features','Remote data access setup','Advanced user security','Multi-location inventory','Priority implementation support','On-site team training'],cta:'Get Gold'},
  ...
  faqs: [
    ...
    {id:'8',q:'Can I migrate from QuickBooks/Sage?',a:'Yes, we handle full data migration from QuickBooks, Sage, Excel, and other systems. All historical data is accurately transferred with zero downtime.',cat:'Services'},
